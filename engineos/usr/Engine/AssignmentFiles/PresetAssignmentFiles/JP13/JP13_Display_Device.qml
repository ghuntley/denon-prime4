...
Device {
	...
	function setElementARGB(elementId, color) {
		...
		Midi.sendSysEx("F0 00 02 0B 01 0D 0B 00 09 %1 %2 F7".arg(device.d2h(elementId)).arg(colorToHex(color)))
	}
...
property Timer updateDisplayDelayTimer: Timer {
	...
	function updateDisplayElements() {
		...
		var sysEx = "F0 00 02 0B 01 0D 0A 00 04 "
	...
	property Timer keepAliveTimer: Timer {
		interval: 40
		repeat: true
		onTriggered: {
			Midi.sendSysEx("F0 00 02 0B 01 0D 7F 00 00 F7") // Send Keep Alive Message
		}
	}
	...
	Component.onCompleted: {
		...
		Midi.sendSysEx("F0 00 02 0B 01 0D 10 00 00 F7") // Start decoding images
	...
	Component.onDestruction: {
		...
		Midi.sendSysEx("F0 7E 7F 06 01 F7")
