...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES dnslookup;dtls;ftp;http;localserver;networkdiskcache;networkinterface;networkproxy;opensslv11;ssl;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES bearermanagement;sctp;socks5)
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.12.6" "" )
